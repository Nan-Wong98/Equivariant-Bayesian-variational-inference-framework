...
### demosaic
```
python train_demosaic_simulate.py --idx 1 --data_path ../../DataSet --dataset CAVE --epochs 10000 --train_size 64 --stride 32 --batch_size 1 --lr_decay --save_freq 50 --device 5 --noise_level 0.01 0.05
```

### pansharpening
```
python train_pansharpening_simulate.py --idx 2 --data_path ../../DataSet --dataset CAVE --epochs 100 --train_size 64 --stride 32 --batch_size 16  --resume_demosaic ./1/model/best_129.pth --lr_decay --save_freq 50 --device 3 --noise_level 0.01 0.05
```

## 🔵 ICVL
### demosaic
```
python train_demosaic_simulate.py --idx 3 --data_path ../../DataSet --dataset ICVL --epochs 200 --train_size 64 --stride 32 --batch_size 16 --lr_decay --save_freq 50 --device 4 --noise_level 0.008 0.01
```

### pansharpening
```
python train_pansharpening_simulate.py --idx 4 --data_path ../../DataSet --dataset ICVL --epochs 10 --train_size 64 --stride 64 --batch_size 16  --resume_demosaic ./3/model/best_57.pth --lr_decay --save_freq 5 --device 6 --noise_level 0.008 0.01
```
...
### generate all
```
python generate.py --idx 1 --simulate --mosaic_save --pan_save --demosaic_save --gt_save --data_path ../../DataSet/ --dataset CAVE --load_demosaic_model ./1/model/best_129.pth --load_ps_model ./2/model/best_9.pth --noise_level 0.01 0.05
```

### generate single
```
python generate.py --idx 1 --simulate --mosaic_save --pan_save --demosaic_save --gt_save --data_path ../../DataSet/ --dataset CAVE --load_demosaic_model ./1/model/best_129.pth --load_ps_model ./2/model/best_9.pth --noise_level 0.01 0.05 --data_id jelly_beans_ms.mat
```

## 🔵 ICVL
### generate all
```
python generate.py --idx 1 --simulate --mosaic_save --pan_save --demosaic_save --gt_save --data_path ../../DataSet/ --dataset ICVL --load_demosaic_model ./3/model/best_200.pth --load_ps_model ./4/model/best_7.pth --noise_level 0.008 0.01
```

### generate single
```
python generate.py --idx 1 --simulate --mosaic_save --pan_save --demosaic_save --gt_save --data_path ../../DataSet/ --dataset ICVL --load_demosaic_model ./3/model/best_200.pth --load_ps_model ./4/model/best_7.pth --noise_level 0.008 0.01 --data_id pepper_0503-1228.mat
```
