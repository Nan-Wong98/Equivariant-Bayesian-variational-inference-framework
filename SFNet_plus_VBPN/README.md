...
### demosaic
```
python train_demosaic_simulate.py --idx 3 --data_path ../../DataSet --dataset CAVE --epochs 10000 --train_size 64 --stride 32 --batch_size 1 --lr_decay --save_freq 50 --device 3 --noise_level 0.01 0.05
```

### pansharpening
```
python train_pansharpening_simulate.py --idx 2 --data_path ../../DataSet --dataset CAVE --epochs 100 --train_size 64 --stride 32 --batch_size 16  --resume_demosaic ./1/model/best_1255.pth --lr_decay --save_freq 5 --device 1 --noise_level 0.01 0.05
```

## 🔵 ICVL
### demosaic
```
python train_demosaic_simulate.py --idx 3 --data_path ../../DataSet --dataset ICVL --epochs 400 --train_size 64 --stride 32 --batch_size 16 --lr_decay --save_freq 50 --device 3 --noise_level 0.008 0.01
```

### pansharpening
```
python train_pansharpening_simulate.py --idx 4 --data_path ../../DataSet --dataset ICVL --epochs 10 --train_size 64 --stride 64 --batch_size 16  --resume_demosaic ./3/model/best_96.pth --lr_decay --save_freq 5 --device 6 --noise_level 0.008 0.01
```
...
### pansharpening
```
python train_pansharpening_realworld.py --idx 6 --data_path ../../DataSet --dataset real_world --epochs 10 --train_size 64 --stride 64 --batch_size 16  --resume_demosaic ./5/model/best_499.pth --lr_decay --save_freq 1 --visual --visual_freq 1 --device 0
```
...
### generate all
```
python generate.py --idx 1 --simulate --mosaic_save --pan_save --demosaic_save --gt_save --data_path ../../DataSet/ --dataset CAVE --load_demosaic_model ./1/model/best_1255.pth --load_ps_model ./2/model/best_25.pth --noise_level 0.01 0.05
```

### generate single
```
python generate.py --idx 1 --simulate --mosaic_save --pan_save --demosaic_save --gt_save --data_path ../../DataSet/ --dataset CAVE --load_demosaic_model ./1/model/best_1255.pth --load_ps_model ./2/model/best_25.pth --noise_level 0.01 0.05 --data_id jelly_beans_ms.mat
```

## 🔵 ICVL
### generate all
```
python generate.py --idx 1 --simulate --mosaic_save --pan_save --demosaic_save --gt_save --data_path ../../DataSet/ --dataset ICVL --load_demosaic_model ./3/model/best_96.pth --load_ps_model ./4/model/best_1.pth --noise_level 0.008 0.01
```

### generate single
```
python generate.py --idx 1 --simulate --mosaic_save --pan_save --demosaic_save --gt_save --data_path ../../DataSet/ --dataset ICVL --load_demosaic_model ./3/model/best_96.pth --load_ps_model ./4/model/best_1.pth --noise_level 0.008 0.01 --data_id pepper_0503-1228.mat
```

## 🟠 RealWorld
### generate all
```
python generate.py --idx 1 --real_world --mosaic_save --pan_save --demosaic_save --data_path ../../DataSet/ --dataset real_world --load_demosaic_model ./5/model/best_499.pth --load_ps_model ./6/model/best_6.pth
```

### generate single
```
python generate.py --idx 1 --real_world --mosaic_save --pan_save --demosaic_save --data_path ../../DataSet/ --dataset real_world --load_demosaic_model ./5/model/best_499.pth --load_ps_model ./6/model/best_6.pth --data_id 1.raw 16.raw 37.raw
```
...
### test single
```
python test.py --idx 1 --simulate --data_path ./CAVE/1/result/mat/ --data_id jelly_beans_ms.mat
```
## 🔵 ICVL
### test all
```
...
### test single
```
python test.py --idx 1 --simulate --data_path ./ICVL/1/result/mat/ --data_id pepper_0503-1228.mat
```
## 🟠 RealWorld
### test all
```
...
### visualize upmosaic
```
python visualize.py --visual_task rgb --spatial_ratio 8 --mat_path ./CAVE/1/result/mat/mosaic/ --save_path ./CAVE/1/result/rgb/upmosaic/ --data_id jelly_beans_ms.mat --detach --detach_size 25 25 --detach_coordinate 210 98 210 98 --boxcolor b --boxwidth 1
```
...
### visualize pan
```
python visualize.py --visual_task rgb --spatial_ratio 8 --mat_path ./ICVL/1/result/mat/pan/ --save_path ./ICVL/1/result/rgb/pan/ --data_type pan --data_id pepper_0503-1228.mat --detach --detach_size 128 128 --detach_coordinate 300 600 100 160 --boxcolor r
```
...
#### img2
```
python visualize.py --visual_task rgb --spatial_ratio 8 --mat_path ./real_world/1/result/mat/pan/ --save_path ./real_world/1/result/rgb/pan/ --data_id 1.mat --data_type pan --detach --detach_size 128 128 --detach_coordinate 740 270 740 270 --boxwidth 5 --boxcolor b
```
#### img3
```
python visualize.py --visual_task rgb --spatial_ratio 8 --mat_path ./real_world/1/result/mat/pan/ --save_path ./real_world/1/result/rgb/pan/ --data_id 1.mat --data_type pan --detach --detach_size 128 128 --detach_coordinate 740 770 740 770 --boxwidth 5 --boxcolor b
```
...
#### img2
```
python visualize.py --visual_task rgb --spatial_ratio 8 --mat_path ./real_world/1/result/mat/mosaic/ --save_path ./real_world/1/result/rgb/upmosaic/ --data_id 1.mat --data_type upmosaic --detach --detach_size 128 128 --detach_coordinate 740 270 740 270 --boxwidth 5 --boxcolor b
```
#### img3
```
python visualize.py --visual_task rgb --spatial_ratio 8 --mat_path ./real_world/1/result/mat/mosaic/ --save_path ./real_world/1/result/rgb/upmosaic/ --data_id 1.mat --data_type upmosaic --detach_size 128 128 --detach_coordinate 740 770 740 770 --boxwidth 5 --boxcolor b
```